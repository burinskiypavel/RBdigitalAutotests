...
public class ComicPage {
    ...
    public void SwitchToIFrameOpenComicsReadingPage2() throws InterruptedException {
        Thread.sleep(5000);
        int size = driver.findElements(By.tagName("iframe")).size();
        driver.switchTo().frame(0);
        //Thread.sleep(4000);
    ...
    public void SwitchToIFrameOpenComicsReadingPageProd(int comicsID) throws InterruptedException {
        Thread.sleep(5000);
        int size = driver.findElements(By.tagName("iframe")).size();
        //driver.switchTo().frame(0);
        Thread.sleep(4000);
    ...
    public void SwitchToIFrameOpenComicsReadingPageProd2() throws InterruptedException {
        Thread.sleep(5000);
        int size = driver.findElements(By.tagName("iframe")).size();
        driver.switchTo().frame(0);
        //Thread.sleep(4000);
    ...
    public ComicPage openComicsReadingPage() throws InterruptedException {
        SwitchToTab();
        SwitchToIFrameOpenComicsReadingPage2();
        return this;
    }

    public ComicPage openComicsReadingPageProd(int comicsID) throws InterruptedException {
        SwitchToTab();
        SwitchToIFrameOpenComicsReadingPageProd(comicsID);
        return this;
    }

    public ComicPage openComicsReadingPageProd() throws InterruptedException {
        SwitchToTab();
        SwitchToIFrameOpenComicsReadingPageProd2();
        return this;
    }
